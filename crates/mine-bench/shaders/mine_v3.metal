//
// V3 mining kernel — V1's structure (1 nonce per thread) but with
// ulong4 vector loads for R rows. Isolates the load-instruction-shape
// effect from the register-pressure penalty V2 took on dual-nonce.
//
// If V3 beats V1, the gain is real and orthogonal to multi-nonce ILP.
// If V3 ties V1, the compiler was already coalescing the 4 ulong loads.
//
